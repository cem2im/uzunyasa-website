...
// Sarkopeni (yaşa bağlı kas kaybı) reeli için içerik
const SLIDES = [
  {
    id: 'hook',
    bg: 'hook-bg',
    html: `
      <div class="hook-content">
        ...
        <div class="hook-main">KAS KAYBETMEYİ<br>DURDURUN!</div>
        <div class="hook-line"></div>
        <div class="hook-sub">40 yaşından sonra<br>her yıl kas kaybediyorsunuz</div>
      </div>`
  },
  {
    id: 'fact1',
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">40 yaşından sonra<br><span class="accent">her 10 yılda %8</span><br>kas kaybı yaşıyorsunuz</div>
      </div>
      <div class="source-line">Kaynak: Yaşlanma Araştırmaları</div>`
  },
  {
    id: 'fact2',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Sarkopeni <span class="accent">WHO</span> tarafından<br>hastalık kabul edildi<br><span class="accent">ICD-10: M62.84</span></div>
      </div>
      <div class="source-line">Kaynak: EWGSOP2 Uzlaşı Kılavuzu</div>`
  },
  {
    id: 'fact3',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Protein hedefi:<br>günde her kilo için<br><span class="accent">1.2-1.6 gram</span></div>
      </div>
      <div class="source-line">Kaynak: ESPEN Kılavuzu 2021</div>`
  },
  {
    id: 'fact4',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Direnç antrenmanı<br><span class="accent">en etkili tedavi</span><br>— haftada 2-3 gün</div>
      </div>
      <div class="source-line">Kaynak: Cochrane Meta-Analiz</div>`
  },
  {
    id: 'fact5',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Ramazan'da kas kaybı<br><span class="accent">riski artıyor</span><br>— sahurda protein şart!</div>
      </div>
      <div class="source-line">UzunYaşa Uzman Önerisi</div>`
  },
  {
    id: 'summary',
    bg: 'summary-bg',
    html: `
      <div class="summary-content">
        ...
        <div class="summary-main">Kaslarınız<br><span class="accent">uzun yaşamın</span><br>anahtarı</div>
        <div class="summary-sub">Koruyun. Güçlendirin. Yaşayın.</div>
      </div>`
  },
  {
    id: 'cta',
    ...
    html: `
      ...
      <div class="cta-content">
        ...
        <div class="cta-save">Kaydet + Paylaş<br>@uzunyasaorg</div>
...
(async () => {
  ...
  const outDir = path.resolve(__dirname, 'sarkopeni-slides');
  ...
  await browser.close();
  console.log('\nSarkopeni slides rendered successfully!');
})();
...
set -e
BASE="$(dirname "$0")"
BG="$BASE/if-diyabet-backgrounds"
OV="$BASE/if-diyabet-slides"
TMP="/tmp/if-diyabet-reel"
mkdir -p "$TMP"
...
echo "🎬 Compositing IF-Diyabet text overlays on background videos..."
...
echo ""
echo "🔗 Concatenating IF-Diyabet scenes with crossfade transitions..."
...
OUTPUT="$BASE/if-diyabet-reel-final.mp4"
...
cp "$OUTPUT" /home/clawdbot/.openclaw/media/if-diyabet-reel.mp4
echo "  ✅ Copied to: /home/clawdbot/.openclaw/media/if-diyabet-reel.mp4"
echo ""
echo "🎉 IF-Diyabet Instagram Reel production complete!"

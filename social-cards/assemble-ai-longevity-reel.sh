#!/bin/bash
# Assemble AI Longevity reel: reuse v2 backgrounds + new transparent PNG overlays → final reel
set -e

SLIDES_DIR="slides-ai-longevity"
BG_DIR="backgrounds"
OUT_DIR="composited-ai-longevity"
FINAL="ai-longevity-reel-final.mp4"

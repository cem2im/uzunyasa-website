...
// Bağırsak Mikrobiyotası ve Obezite reeli için içerik
const SLIDES = [
  {
    id: 'hook',
    bg: 'hook-bg',
    html: `
      <div class="hook-content">
        ...
        <div class="hook-main">KİLONUZU<br>BAĞIRSAKLARINIZ MI<br>BELİRLİYOR?</div>
        <div class="hook-line"></div>
        <div class="hook-sub">Mikrobiyota ve obezite<br>arasındaki bağlantı</div>
      </div>`
  },
  {
    id: 'fact1',
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Bağırsak bakterileri<br><span class="accent">GLP-1 hormonu</span><br>üretimini etkiliyor</div>
      </div>
  ...
  },
  {
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main"><span class="accent">Akkermansia</span> bakterisi<br>zayıf insanlarda<br>daha fazla bulunuyor</div>
      </div>
  ...
  },
  {
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Kısa zincirli yağ asitleri<br><span class="accent">tokluk sinyali</span><br>gönderiyor beyninize</div>
      </div>
  ...
  },
  {
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Probiyotik kapsüller<br><span class="accent">kilo verdirmiyor</span><br>— meta-analizler bunu gösteriyor</div>
      </div>
  ...
  },
  {
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Bağırsak → <span class="accent">vagus siniri</span><br>→ beyin: gut-beyin<br>ekseni her şeyi kontrol ediyor</div>
      </div>
  ...
  },
  {
    ...
    html: `
      <div class="summary-content">
        ...
        <div class="summary-main">Mikrobiyota önemli ama<br><span class="accent">"probiyotik al<br>kilo ver"</span> gerçekçi değil</div>
        <div class="summary-sub">Bilimsel ol. Gerçekçi ol.</div>
      </div>`
  },
  {
    id: 'cta',
    ...
    html: `
      ...
      <div class="cta-content">
        ...
        <div class="cta-save">Detaylı bilgi için<br>uzunyasa.com</div>

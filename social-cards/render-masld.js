...
// Karaciğer Yağlanması (MASLD) — Cerrahisiz Çözümler reeli
const SLIDES = [
  {
    id: 'hook',
    bg: 'hook-bg',
    html: `
      <div class="hook-content">
        ...
        <div class="hook-main">KARACİĞERİNİZİN<br><span style="color:#E8963E">%48'İ</span> YAĞLI<br>OLABİLİR!</div>
        <div class="hook-line"></div>
        <div class="hook-sub">Türkiye'de karaciğer<br>yağlanması salgın boyutunda</div>
      </div>`
  },
  {
    id: 'fact1',
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Türkiye'de neredeyse<br><span class="accent">her 2 kişiden 1'inde</span><br>karaciğer yağlanması var</div>
      </div>
      <div class="source-line">Kaynak: Türk Gastroenteroloji Derneği</div>`
  },
  {
    id: 'fact2',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">NAFLD artık <span class="accent">MASLD</span><br>Yeni isim, aynı tehlike —<br>siroz ve kanser riski taşıyor</div>
      </div>
      <div class="source-line">Kaynak: AASLD / Hepatology 2023</div>`
  },
  {
    id: 'fact3',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main"><span class="accent">%7-10</span> kilo kaybı<br>karaciğer yağını<br>eritmeye yetiyor</div>
      </div>
      <div class="source-line">Kaynak: EASL Kılavuzu 2024</div>`
  },
  {
    id: 'fact4',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main"><span class="accent">Endoskopik sleeve</span><br>Ameliyatsız mide küçültme<br>— kesi yok, iz yok</div>
      </div>
      <div class="source-line">Kaynak: Gastrointestinal Endoscopy</div>`
  },
  {
    id: 'fact5',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main"><span class="accent">Semaglutid + Resmetirom</span><br>İlaçla tedavi dönemi<br>resmen başladı</div>
      </div>
      <div class="source-line">Kaynak: FDA / NEJM 2024</div>`
  },
  {
    id: 'summary',
    bg: 'summary-bg',
    html: `
      <div class="summary-content">
        ...
        <div class="summary-main">Karaciğer yağlanması<br><span class="accent">tedavi edilebilir</span></div>
        <div class="summary-sub">Cerrahisiz seçenekler var.</div>
      </div>`
  },
  {
    id: 'cta',
...
(async () => {
  ...
  const outDir = path.resolve(__dirname, 'masld-slides');
  ...
  await browser.close();
  console.log('\nMASLD slides rendered successfully!');
})();

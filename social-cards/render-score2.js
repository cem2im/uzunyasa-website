...
// SCORE2 Kalp Krizi Risk Hesaplama - 8 slides
const SLIDES = [
  {
    id: 'hook',
    bg: 'hook-bg',
    html: `
      <div class="hook-content">
        ...
        <div class="hook-main">KALBİNİZ KAÇ YIL DAHA DAYANACAK?</div>
        <div class="hook-line"></div>
        <div class="hook-sub">10 yılda kalp krizi<br>riskinizi hesaplayın!</div>
      </div>`
  },
  {
    id: 'fact1',
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Her 3 Türk'ten <span class="accent">1'i</span><br>kalp-damar hastalığından<br>ölüyor</div>
        <div class="fact-sub">Türkiye yüksek riskli bölge</div>
      </div>
      <div class="source-line">Kaynak: TÜİK, Türkiye İstatistik Kurumu</div>`
  },
  {
    id: 'fact2',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main"><span class="accent">SCORE2:</span> Avrupa'nın<br>yeni risk hesaplayıcısı</div>
        <div class="fact-sub">700.000 kişi, 45 ülke verisi</div>
      </div>
      <div class="source-line">Kaynak: European Heart Journal, 2021</div>`
  },
  {
    id: 'fact3',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main"><span class="accent">5 dakikada</span> riskinizi<br>öğrenin: yaş, kan basıncı<br>kolesterol, sigara</div>
      </div>`
  },
  {
    id: 'fact4',
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Sigara bırakma → risk <span class="accent">%50</span> düşer!<br>Kolesterol kontrolü →<br>risk <span class="accent">%30</span> düşer!</div>
      </div>
      <div class="source-line">Kaynak: ESC Kalp Hastalıkları Rehberi</div>`
  },
  {
    id: 'fact5',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main"><span class="accent">40 yaşından</span> sonra<br>herkes hesaplamalı</div>
        <div class="fact-sub">Erken teşhis hayat kurtarır</div>
      </div>`
  },
  {
    id: 'summary',
    ...
    html: `
      <div class="summary-content">
        ...
        <div class="summary-main">Riskinizi bilin,<br><span class="accent">önlem alın</span><br>daha uzun yaşayın</div>
      </div>`
  },
  {
    id: 'cta',
    ...
    html: `
      ...
      <div class="cta-content">
        ...
        <div class="cta-save">Kaydet + Paylaş</div>
        <div class="cta-url-main">uzunyasa.com</div>
        <div class="cta-sub">hesaplayıcı linki</div>
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .hook-sub {
    font-size: 42px; font-weight: 600; line-height: 1.35;
  ...
  .fact-main {
    font-size: 44px; font-weight: 700; line-height: 1.4;
    text-shadow: 0 2px 20px rgba(0,0,0,0.9), 0 0 40px rgba(0,0,0,0.7);
    margin-bottom: 20px;
  }
  .fact-sub {
    font-size: 32px; font-weight: 600; color: rgba(255,255,255,0.8);
  ...
  .cta-save { font-size: 48px; font-weight: 700; line-height: 1.4; margin-bottom: 30px; }
  .cta-url-main { font-size: 36px; font-weight: 900; color: #E8963E; margin-bottom: 10px; }
  .cta-sub { font-size: 24px; color: rgba(255,255,255,0.6); margin-bottom: 30px; }
  .cta-handle { font-size: 26px; color: rgba(255,255,255,0.5); }
...
(async () => {
  ...
  const outDir = path.resolve(__dirname, 'score2-slides');

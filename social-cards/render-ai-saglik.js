...
// AI Sağlık Reeli — 8 slide, halkın anlayacağı dil
const SLIDES = [
  {
    id: 'hook',
    bg: 'hook-bg',
    html: `
      <div class="hook-content">
        ...
        <div class="hook-main">YAPAY ZEKA<br>SAĞLIKTA DEVRİM!</div>
        <div class="hook-line"></div>
        <div class="hook-sub">Doktorunuz yakında bir<br>yapay zeka olabilir</div>
      </div>`
  },
  {
    id: 'fact1',
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">İlaç geliştirmek eskiden<br><span class="accent">5 yıl</span> sürüyordu<br>Yapay zeka ile <span class="accent">18 aya</span> düştü!</div>
      </div>
      <div class="source-line">Kaynak: Insilico Medicine, 2024</div>`
  },
  {
    id: 'fact2',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Şu anda <span class="accent">1000'den fazla</span><br>yapay zeka tıbbi cihaz<br>Amerika'da onaylı</div>
      </div>
      <div class="source-line">Kaynak: FDA AI/ML Cihaz Listesi, 2026</div>`
  },
  {
    id: 'fact3',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Yapay zeka akciğer kanserini<br><span class="accent">%20 daha erken</span> tespit ediyor<br>Kalp krizini <span class="accent">6 saat önceden</span> tahmin!</div>
      </div>
      <div class="source-line">Kaynak: Nature Medicine</div>`
  },
  {
    id: 'fact4',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Vücudunuzun <span class="accent">dijital ikizi</span><br>yapılacak — ilaçlar önce<br>sanal kopyanızda denenecek</div>
      </div>
      <div class="source-line">🟡 Akademik araştırma aşamasında</div>`
  },
  {
    id: 'fact5',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">2030'a kadar <span class="accent">kişiye özel</span><br>kanser aşısı geliyor<br>mRNA + yapay zeka ile</div>
      </div>
      <div class="source-line">Kaynak: BioNTech/Moderna Faz 2 Çalışması</div>`
  },
  {
    id: 'summary',
    bg: 'summary-bg',
    html: `
      <div class="summary-content">
        ...
        <div class="summary-main">Geleceğin doktoru<br><span class="accent">hastalığı oluşmadan</span><br>önleyecek</div>
        <div class="summary-sub">AI + Tıp = Devrim</div>
      </div>`
  },
  {
    id: 'cta',
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .hook-main {
    font-size: 82px; font-weight: 900; line-height: 1.1;
  ...
  .cta-save { font-size: 36px; font-weight: 600; line-height: 1.4; margin-bottom: 40px; text-shadow: 0 2px 15px rgba(0,0,0,0.9); }
...
(async () => {
  ...
  const outDir = path.resolve(__dirname, 'ai-saglik-slides');

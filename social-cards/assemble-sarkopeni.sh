...
set -e
BASE="$(dirname "$0")"
BG="$BASE/sarkopeni-backgrounds"
OV="$BASE/sarkopeni-slides"
TMP="/tmp/sarkopeni-reel"
mkdir -p "$TMP"
...
echo "🎬 Compositing Sarkopeni text overlays on background videos..."
...
echo ""
echo "🔗 Concatenating Sarkopeni scenes with crossfade transitions..."
...
OUTPUT="$BASE/sarkopeni-reel-final.mp4"
...
cp "$OUTPUT" /home/clawdbot/.openclaw/media/sarkopeni-reel.mp4
echo "  ✅ Copied to: /home/clawdbot/.openclaw/media/sarkopeni-reel.mp4"
echo ""
echo "🎉 Sarkopeni Instagram Reel production complete!"
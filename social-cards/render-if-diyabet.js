...
// Intermittent Fasting ve Tip 2 Diyabet — Ramazan bağlantısı
const SLIDES = [
  {
    id: 'hook',
    bg: 'hook-bg',
    html: `
      <div class="hook-content">
        ...
        <div class="hook-main">ORUÇ DİYABETİ<br>TEDAVİ EDER Mİ?</div>
        <div class="hook-line"></div>
        <div class="hook-sub">Bilimin cevabı<br>sizi şaşırtabilir!</div>
      </div>`
  },
  {
    id: 'fact1',
    ...
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">16:8 ve 5:2 oruç modelleri<br><span class="accent">HbA1c'yi düşürdü</span><br>— kontrollü çalışmalarda</div>
      </div>
      <div class="source-line">Kaynak: Randomize Kontrollü Çalışmalar</div>`
  },
  {
    id: 'fact2',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Ama <span class="accent">NEJM 2022</span> şok etti:<br>Zamana kısıtlı yeme,<br>standart diyetten<br><span class="accent">daha iyi DEĞİL!</span></div>
      </div>
      <div class="source-line">Kaynak: NEJM, 2022</div>`
  },
  {
    id: 'fact3',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Ramazan orucu ≠<br><span class="accent">tıbbi intermittent fasting</span><br>— süre, su ve ilaç<br>kullanımı farklı!</div>
      </div>
      <div class="source-line">Kaynak: Diabetes Care Kılavuzu</div>`
  },
  {
    id: 'fact4',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Diyabet hastasında oruç →<br><span class="accent">hipoglisemi riski!</span> ⚠️<br>Mutlaka doktor kontrolü</div>
      </div>
      <div class="source-line">Kaynak: IDF-DAR Kılavuzu 2021</div>`
  },
  {
    id: 'fact5',
    bg: 'fact-bg',
    html: `
      <div class="fact-content">
        ...
        <div class="fact-main">Meta-analiz sonucu:<br>IF diyabet yönetiminde<br><span class="accent">"umut verici ama<br>kesin değil"</span></div>
      </div>
      <div class="source-line">Kaynak: Cochrane Sistematik Derleme</div>`
  },
  {
    id: 'summary',
    bg: 'summary-bg',
    html: `
      <div class="summary-content">
        ...
        <div class="summary-main">IF faydalı olabilir ama<br><span class="accent">"diyabeti tedavi eder"</span><br>demek henüz erken</div>
        <div class="summary-sub">Bilim. Denge. Dikkat.</div>
      </div>`
  },
  {
    id: 'cta',
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .hook-main {
    font-size: 74px; font-weight: 900; line-height: 1.1;
  ...
  .summary-main {
    font-size: 50px; font-weight: 900; line-height: 1.3;
    margin-bottom: 30px;
    text-shadow: 0 2px 20px rgba(0,0,0,0.9), 0 0 40px rgba(0,0,0,0.7);
  }
  .summary-sub {
...
(async () => {
  ...
  const outDir = path.resolve(__dirname, 'if-diyabet-slides');
  ...
  await browser.close();
  console.log('\nIF-Diyabet slides rendered successfully!');
})();
